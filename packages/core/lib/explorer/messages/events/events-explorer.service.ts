...
export class EventsExplorerService implements IMessageTypeExplorer {
  ...
  explore(messageTypeProviders: Map<string, IMessageTypeProvider[]>): IMessageTypeExplorerResult<IEventsProviders> {
    const providers: IEventsProviders = {
    ...
    return {
      ...
      flattenedProviders: [
        ...
        ...[...providers.specific.values()].flatMap(({ handlers }) => handlers),
      ],
    };
  }
